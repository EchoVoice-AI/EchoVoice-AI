...
- [🚀 **EchoVoice:**: Data ingestion](#-echovoice-data-ingestion)
  ...
  - [Ingestion stages](#ingestion-stages)
    ...
    - [Figure merging](#figure-merging)
      - [Chunking](#chunking)
      - [Embedding](#embedding)
    - [Indexing](#indexing)
  - [Local ingestion](#local-ingestion)
    - [Enhancing search functionality with data categorization](#enhancing-search-functionality-with-data-categorization)
  ...
  - [Cloud ingestion](#cloud-ingestion)
    ...
    - [Indexer architecture](#indexer-architecture)
      - [Document Extractor Function](#document-extractor-function)
      - [Figure Processor Function](#figure-processor-function)
      - [Shaper Skill](#shaper-skill)
      - [Text Processor Function](#text-processor-function)
