# 🚀 **EchoVoice**: HTTP Protocol

The frontend and backend of this Agent Orchestrator application exchange messages over HTTP, using both regular JSON for single responses and streaming newline-delimited JSON (NDJSON) for streamed responses.
...
- [🚀 **EchoVoice**: HTTP Protocol](#-echovoice-http-protocol)
