"""Experimentation phase nodes used for A/B testing simulation and feedback.

These helpers are lightweight simulation stubs intended for local development
and unit testing of the orchestration flow.
"""
...
async def experimentation_node(
    ...
    """Handle variant assignment, simulate performance, and process feedback.

    Returns a dictionary with keys for the winning variant, predicted
    performance stats, processed feedback, and the experiment assignment.
    """
